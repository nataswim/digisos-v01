...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('editor.videos.update', $video) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        <div class="row g-4">
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $video->title) }}" class="form-control form-control-lg @error('title') is-invalid @enderror" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $video->slug) }}" class="form-control @error('slug') is-invalid @enderror">
                            </div>
                            @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="d-none @error('description') is-invalid @enderror">{{ old('description', $video->description) }}</textarea>
                            @error('description')
                        ...
                        <div class="mb-4" id="urlSection" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="url" name="external_url" id="external_url" value="{{ old('external_url', $video->external_url) }}" class="form-control @error('external_url') is-invalid @enderror">
                        ...
                        <div class="border-top pt-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="duration" id="duration" value="{{ old('duration', $video->duration) }}" class="form-control" min="0">
                                </div>
                                <div class="col-md-4">
                                    <label for="width" class="form-label">Largeur (px)</label>
                                    <input type="number" name="width" id="width" value="{{ old('width', $video->width) }}" class="form-control" min="0">
                                </div>
                                <div class="col-md-4">
                                    <label for="height" class="form-label">Hauteur (px)</label>
                                    <input type="number" name="height" id="height" value="{{ old('height', $video->height) }}" class="form-control" min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-top pt-4 mt-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $video->meta_title) }}" class="form-control" maxlength="60">
                                </div>
                                <div class="col-md-6">
                                    <label for="meta_keywords" class="form-label">Mots-clés</label>
                                    <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $video->meta_keywords) }}" class="form-control">
                                </div>
                                <div class="col-12">
                                    <label for="meta_description" class="form-label">Description SEO</label>
                                    <textarea name="meta_description" id="meta_description" rows="3" class="form-control" maxlength="160">{{ old('meta_description', $video->meta_description) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <select name="is_published" id="is_published" class="form-select">
                                <option value="0" {{ old('is_published', $video->is_published) == 0 ? 'selected' : '' }}>Brouillon</option>
                                <option value="1" {{ old('is_published', $video->is_published) == 1 ? 'selected' : '' }}>Publié</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="visibility" id="visibility" class="form-select">
                                ...
                                <option value="authenticated" {{ old('visibility', $video->visibility) === 'authenticated' ? 'selected' : '' }}>Membres uniquement</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="published_at" class="form-label fw-semibold">Date de publication</label>
                            <input type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at', $video->published_at?->format('Y-m-d\TH:i')) }}" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="sort_order" class="form-label fw-semibold">Ordre</label>
                            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $video->sort_order) }}" class="form-control">
                        </div>

                        <div class="form-check mb-3">
                            <input type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $video->is_featured) ? 'checked' : '' }} class="form-check-input">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="categories[]" value="{{ $category->id }}" id="category_{{ $category->id }}" {{ in_array($category->id, old('categories', $video->categories->pluck('id')->toArray())) ? 'checked' : '' }}>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="input-group">
                            <input type="text" name="thumbnail" id="thumbnail" value="{{ old('thumbnail', $video->thumbnail) }}" class="form-control">
                        ...
                        <div class="mt-3" id="thumbnailPreviewContainer">
                            <img src="{{ $video->thumbnail }}" id="thumbnailPreview" alt="Aperçu" class="img-fluid rounded" style="max-height: 150px;">
                        </div>
                        @else
