...
/**
 * 🇬🇧 UpdatePageRequest - Validation for updating a page
 * 🇫🇷 UpdatePageRequest - Validation pour mettre à jour une page
 * 
...
class UpdatePageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:191|unique:pages,slug,' . $this->page->id,
